...
!function ($) {
  ...
  * =============================== */
  ...
  Garlic.prototype = {
    ...
    , swapHandler: function () {
      ...
      swapChoiceElem.on( 'touch', false, $.proxy( this.swap, this ) );
    }
  ...
  * ========================= */
  ...
  $.fn.garlic.defaults = {
    ...
    , events: [ 'DOMAttrModified', 'textInput', 'input', 'change', 'ontouch', 'keypress', 'paste', 'focus' ]  // Events list that trigger a localStorage
